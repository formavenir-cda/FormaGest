...
public class JwtService {
    ...
    // Génère le token utilisé après authentification : porte le rôle en claim,
    // lisible côté front, sans que l'autorisation côté serveur en dépende
    // (elle repasse toujours par UserDetailsService à chaque requête).
